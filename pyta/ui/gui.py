...
class Ui_pyTAgui(object):
    def setupUi(self, pyTAgui):
        ...
        self.a_delay_t0 = QtWidgets.QDoubleSpinBox(self.a_acquire_box)
        ...
        self.a_sweep_display.setStyleSheet(
            "color: rgb(255, 255, 0);\n"
        ...
        self.a_time_display.setStyleSheet(
            "background-color: rgb(0, 0, 0);\n"
            "                                    color: rgb(0, 255, 255);\n"
            "                                "
        )
        ...
        self.d_delay_t0 = QtWidgets.QDoubleSpinBox(self.d_acquire_box)
        ...
        self.converter_tab.setObjectName("converter_tab")
        self.centralwidget = QtWidgets.QWidget(self.converter_tab)
        self.centralwidget.setGeometry(QtCore.QRect(0, 0, 821, 471))
        self.centralwidget.setObjectName("centralwidget")
        ...
        self.file_list.setProperty("dragEnabled", True)
    ...
    def retranslateUi(self, pyTAgui):
        ...
        self.input_file_gbox.setTitle(_translate("pyTAgui", 'drag and drop hdf5 files, then hit "load all"'))
        self.file_up.setText(_translate("pyTAgui", "move up"))
        self.file_down.setText(_translate("pyTAgui", "move down"))
        self.delete_button.setText(_translate("pyTAgui", "delete"))
        self.load_button.setText(_translate("pyTAgui", "load all"))
        self.groupBox.setTitle(_translate("pyTAgui", "choose a folder for the extracted data to be saved in"))
        self.folder_browser.setText(_translate("pyTAgui", "Browse"))
        self.groupBox_2.setTitle(_translate("pyTAgui", "choose types of data to save"))
        self.average_check.setText(_translate("pyTAgui", "averaged dT/T data"))
        self.metadata_check.setText(_translate("pyTAgui", "metadata"))
        self.spectra_check.setText(_translate("pyTAgui", "probe, reference and error spectra for each sweep"))
        self.sweeps_check.setText(_translate("pyTAgui", "dT/T data for each sweep"))
        self.convert_button.setText(_translate("pyTAgui", "convert"))
        self.groupBox_3.setTitle(_translate("pyTAgui", "information"))
        self.tabs.setTabText(self.tabs.indexOf(self.converter_tab), _translate("pyTAgui", "File Conversion"))
