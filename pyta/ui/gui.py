...
class Ui_pyTAgui(object):
    def setupUi(self, pyTAgui):
        ...
        self.centralWidget = QtWidgets.QWidget(parent=pyTAgui)
        ...
        self.h_disconnect_camera_btn = QtWidgets.QPushButton(parent=self.h_camera_box)
        ...
        self.h_delay_status = QtWidgets.QLabel(parent=self.h_delay_box)
        self.h_delay_status.setGeometry(QtCore.QRect(10, 90, 231, 21))
        self.h_delay_status.setFrameShape(QtWidgets.QFrame.Shape.Panel)
        self.h_delay_status.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        ...
        self.a_times_box = QtWidgets.QGroupBox(parent=self.acquisition_tab)
        ...
        self.a_distribution_dd = QtWidgets.QComboBox(parent=self.a_times_box)
        self.a_distribution_dd.setGeometry(QtCore.QRect(10, 100, 91, 23))
        self.a_distribution_dd.setObjectName("a_distribution_dd")
        self.a_tstart_sb = QtWidgets.QDoubleSpinBox(parent=self.a_times_box)
        ...
        self.a_tend_sb = QtWidgets.QDoubleSpinBox(parent=self.a_times_box)
        ...
        self.a_num_tpoints_sb = QtWidgets.QSpinBox(parent=self.a_times_box)
        ...
        self.a_folder_btn = QtWidgets.QPushButton(parent=self.a_file_box)
        self.a_folder_btn.setGeometry(QtCore.QRect(10, 30, 71, 23))
        self.a_folder_btn.setObjectName("a_folder_btn")
        self.a_metadata_pump_wavelength = QtWidgets.QLineEdit(parent=self.a_file_box)
        ...
        self.a_metadata_pump_power = QtWidgets.QLineEdit(parent=self.a_file_box)
        ...
        self.a_metadata_pump_spotsize = QtWidgets.QLineEdit(parent=self.a_file_box)
        ...
        self.label_65 = QtWidgets.QLabel(parent=self.a_file_box)
        self.label_65.setGeometry(QtCore.QRect(90, 110, 71, 21))
        self.label_65.setObjectName("label_65")
        self.label_66 = QtWidgets.QLabel(parent=self.a_file_box)
        self.label_66.setGeometry(QtCore.QRect(90, 130, 47, 21))
        self.label_66.setObjectName("label_66")
        self.label_67 = QtWidgets.QLabel(parent=self.a_file_box)
        self.label_67.setGeometry(QtCore.QRect(90, 150, 61, 21))
        self.label_67.setObjectName("label_67")
        self.a_metadata_probe_wavelength = QtWidgets.QLineEdit(parent=self.a_file_box)
        ...
        self.label_68 = QtWidgets.QLabel(parent=self.a_file_box)
        self.label_68.setGeometry(QtCore.QRect(260, 110, 71, 21))
        self.label_68.setObjectName("label_68")
        self.a_metadata_probe_spotsize = QtWidgets.QLineEdit(parent=self.a_file_box)
        ...
        self.label_69 = QtWidgets.QLabel(parent=self.a_file_box)
        self.label_69.setGeometry(QtCore.QRect(260, 150, 71, 21))
        self.label_69.setObjectName("label_69")
        self.a_metadata_probe_power = QtWidgets.QLineEdit(parent=self.a_file_box)
        ...
        self.label_70 = QtWidgets.QLabel(parent=self.a_file_box)
        self.label_70.setGeometry(QtCore.QRect(260, 130, 47, 21))
        self.label_70.setObjectName("label_70")
        self.a_filepath_le = QtWidgets.QLineEdit(parent=self.a_file_box)
        self.a_filepath_le.setGeometry(QtCore.QRect(10, 60, 321, 23))
        self.a_filepath_le.setObjectName("a_filepath_le")
        self.a_filename_le = QtWidgets.QLineEdit(parent=self.a_file_box)
        self.a_filename_le.setGeometry(QtCore.QRect(90, 30, 241, 23))
        self.a_filename_le.setObjectName("a_filename_le")
        self.label = QtWidgets.QLabel(parent=self.a_file_box)
        self.label.setGeometry(QtCore.QRect(10, 90, 59, 15))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(parent=self.a_file_box)
        self.label_2.setGeometry(QtCore.QRect(180, 90, 59, 15))
        self.label_2.setObjectName("label_2")
        self.a_acquire_box = QtWidgets.QGroupBox(parent=self.acquisition_tab)
        self.a_acquire_box.setGeometry(QtCore.QRect(10, 410, 341, 151))
        self.a_acquire_box.setObjectName("a_acquire_box")
        self.a_delay_t0 = QtWidgets.QDoubleSpinBox(parent=self.a_acquire_box)
        self.a_delay_t0.setGeometry(QtCore.QRect(10, 30, 71, 22))
        self.a_delay_t0.setMinimum(-100000.0)
        self.a_delay_t0.setMaximum(100000.0)
        self.a_delay_t0.setObjectName("a_delay_t0")
        self.a_num_shots = QtWidgets.QSpinBox(parent=self.a_acquire_box)
        ...
        self.label_5 = QtWidgets.QLabel(parent=self.a_acquire_box)
        self.label_5.setGeometry(QtCore.QRect(90, 30, 141, 21))
        self.label_5.setObjectName("label_5")
        self.label_7 = QtWidgets.QLabel(parent=self.a_acquire_box)
        self.label_7.setGeometry(QtCore.QRect(90, 100, 121, 21))
        self.label_7.setObjectName("label_7")
        self.a_num_sweeps = QtWidgets.QSpinBox(parent=self.a_acquire_box)
...
"color: rgb(0, 255, 255);")
        ...
        self.a_calib_wave_low = QtWidgets.QSpinBox(parent=self.a_calib_box)
        ...
        self.a_calib_pixel_high = QtWidgets.QSpinBox(parent=self.a_calib_box)
        ...
        self.a_calib_wave_high = QtWidgets.QSpinBox(parent=self.a_calib_box)
        ...
        self.label_10 = QtWidgets.QLabel(parent=self.a_calib_box)
        self.label_10.setGeometry(QtCore.QRect(90, 50, 81, 21))
        self.label_10.setObjectName("label_10")
        self.label_11 = QtWidgets.QLabel(parent=self.a_calib_box)
        self.label_11.setGeometry(QtCore.QRect(90, 70, 71, 21))
        self.label_11.setObjectName("label_11")
        self.label_12 = QtWidgets.QLabel(parent=self.a_calib_box)
        self.label_12.setGeometry(QtCore.QRect(90, 100, 81, 21))
        self.label_12.setObjectName("label_12")
        self.label_13 = QtWidgets.QLabel(parent=self.a_calib_box)
        self.label_13.setGeometry(QtCore.QRect(90, 120, 71, 21))
        self.label_13.setObjectName("label_13")
        self.a_use_calib = QtWidgets.QCheckBox(parent=self.a_calib_box)
        ...
        self.a_launch_box = QtWidgets.QGroupBox(parent=self.acquisition_tab)
        self.a_launch_box.setGeometry(QtCore.QRect(10, 730, 341, 71))
        self.a_launch_box.setObjectName("a_launch_box")
        self.a_run_btn = QtWidgets.QPushButton(parent=self.a_launch_box)
        ...
        self.a_test_run_btn = QtWidgets.QCheckBox(parent=self.a_launch_box)
        ...
        self.a_stop_btn = QtWidgets.QPushButton(parent=self.a_launch_box)
        ...
        self.groupBox_6 = QtWidgets.QGroupBox(parent=self.acquisition_tab)
        self.groupBox_6.setGeometry(QtCore.QRect(1580, 9, 191, 81))
        self.groupBox_6.setObjectName("groupBox_6")
        self.a_plot_log_t_cb = QtWidgets.QCheckBox(parent=self.groupBox_6)
        ...
        self.a_cutoff_box = QtWidgets.QGroupBox(parent=self.acquisition_tab)
        self.a_cutoff_box.setGeometry(QtCore.QRect(190, 570, 161, 151))
        self.a_cutoff_box.setObjectName("a_cutoff_box")
        self.a_use_cutoff = QtWidgets.QCheckBox(parent=self.a_cutoff_box)
        ...
        self.label_15 = QtWidgets.QLabel(parent=self.a_cutoff_box)
        self.label_15.setGeometry(QtCore.QRect(90, 70, 61, 21))
        self.label_15.setObjectName("label_15")
        self.label_14 = QtWidgets.QLabel(parent=self.a_cutoff_box)
        self.label_14.setGeometry(QtCore.QRect(90, 50, 61, 21))
        self.label_14.setObjectName("label_14")
        self.a_cutoff_pixel_high = QtWidgets.QSpinBox(parent=self.a_cutoff_box)
        ...
        self.a_cutoff_pixel_low = QtWidgets.QSpinBox(parent=self.a_cutoff_box)
        ...
        self.a_sweep_progress_bar = QtWidgets.QProgressBar(parent=self.acquisition_tab)
        ...
        self.label_18 = QtWidgets.QLabel(parent=self.acquisition_tab)
        self.label_18.setGeometry(QtCore.QRect(1580, 760, 181, 16))
        self.label_18.setObjectName("label_18")
        self.label_19 = QtWidgets.QLabel(parent=self.acquisition_tab)
        ...
        self.d_refmanip_box = QtWidgets.QGroupBox(parent=self.diagnostics_tab)
        self.d_refmanip_box.setGeometry(QtCore.QRect(10, 10, 341, 161))
        self.d_refmanip_box.setObjectName("d_refmanip_box")
        self.d_refman_vertical_stretch = QtWidgets.QDoubleSpinBox(parent=self.d_refmanip_box)
        ...
        self.d_use_ref_manip = QtWidgets.QCheckBox(parent=self.d_refmanip_box)
        ...
        self.label_42 = QtWidgets.QLabel(parent=self.d_refmanip_box)
        self.label_42.setGeometry(QtCore.QRect(90, 50, 101, 21))
        self.label_42.setObjectName("label_42")
        self.d_refman_vertical_offset = QtWidgets.QDoubleSpinBox(parent=self.d_refmanip_box)
        ...
        self.d_refman_horiz_offset = QtWidgets.QDoubleSpinBox(parent=self.d_refmanip_box)
        ...
        self.d_refman_scale_center = QtWidgets.QDoubleSpinBox(parent=self.d_refmanip_box)
        ...
        self.d_refman_scale_factor = QtWidgets.QDoubleSpinBox(parent=self.d_refmanip_box)
        ...
        self.label_43 = QtWidgets.QLabel(parent=self.d_refmanip_box)
        self.label_43.setGeometry(QtCore.QRect(90, 70, 101, 21))
        self.label_43.setObjectName("label_43")
        self.label_44 = QtWidgets.QLabel(parent=self.d_refmanip_box)
        self.label_44.setGeometry(QtCore.QRect(90, 90, 101, 21))
        self.label_44.setObjectName("label_44")
        self.label_45 = QtWidgets.QLabel(parent=self.d_refmanip_box)
        self.label_45.setGeometry(QtCore.QRect(90, 110, 101, 21))
        self.label_45.setObjectName("label_45")
        self.label_46 = QtWidgets.QLabel(parent=self.d_refmanip_box)
        self.label_46.setGeometry(QtCore.QRect(90, 130, 101, 21))
        self.label_46.setObjectName("label_46")
        self.d_calib_box = QtWidgets.QGroupBox(parent=self.diagnostics_tab)
        self.d_calib_box.setGeometry(QtCore.QRect(10, 180, 171, 151))
        self.d_calib_box.setObjectName("d_calib_box")
        self.d_calib_pixel_low = QtWidgets.QSpinBox(parent=self.d_calib_box)
        ...
        self.d_calib_wave_low = QtWidgets.QSpinBox(parent=self.d_calib_box)
        ...
        self.d_calib_pixel_high = QtWidgets.QSpinBox(parent=self.d_calib_box)
        ...
        self.d_calib_wave_high = QtWidgets.QSpinBox(parent=self.d_calib_box)
        ...
        self.label_23 = QtWidgets.QLabel(parent=self.d_calib_box)
        self.label_23.setGeometry(QtCore.QRect(90, 50, 101, 21))
        self.label_23.setObjectName("label_23")
        self.label_24 = QtWidgets.QLabel(parent=self.d_calib_box)
        self.label_24.setGeometry(QtCore.QRect(90, 70, 71, 21))
        self.label_24.setObjectName("label_24")
        self.label_31 = QtWidgets.QLabel(parent=self.d_calib_box)
        self.label_31.setGeometry(QtCore.QRect(90, 100, 101, 21))
        self.label_31.setObjectName("label_31")
        self.label_32 = QtWidgets.QLabel(parent=self.d_calib_box)
        self.label_32.setGeometry(QtCore.QRect(90, 120, 71, 21))
        self.label_32.setObjectName("label_32")
        self.d_use_calib = QtWidgets.QCheckBox(parent=self.d_calib_box)
        ...
        self.d_acquire_box = QtWidgets.QGroupBox(parent=self.diagnostics_tab)
        self.d_acquire_box.setGeometry(QtCore.QRect(10, 460, 341, 161))
        self.d_acquire_box.setObjectName("d_acquire_box")
        self.d_delay_t0 = QtWidgets.QDoubleSpinBox(parent=self.d_acquire_box)
        self.d_delay_t0.setGeometry(QtCore.QRect(10, 30, 71, 22))
        self.d_delay_t0.setMinimum(-100000.0)
        self.d_delay_t0.setMaximum(100000.0)
        self.d_delay_t0.setObjectName("d_delay_t0")
        self.label_35 = QtWidgets.QLabel(parent=self.d_acquire_box)
        self.label_35.setGeometry(QtCore.QRect(90, 30, 141, 21))
        self.label_35.setObjectName("label_35")
        self.d_delaytype_dd = QtWidgets.QComboBox(parent=self.d_acquire_box)
        self.d_delaytype_dd.setGeometry(QtCore.QRect(210, 130, 121, 22))
        self.d_delaytype_dd.setObjectName("d_delaytype_dd")
        self.label_39 = QtWidgets.QLabel(parent=self.d_acquire_box)
        self.label_39.setGeometry(QtCore.QRect(210, 110, 81, 21))
        self.label_39.setObjectName("label_39")
        self.label_37 = QtWidgets.QLabel(parent=self.d_acquire_box)
        self.label_37.setGeometry(QtCore.QRect(90, 100, 111, 21))
        self.label_37.setObjectName("label_37")
        self.d_num_shots = QtWidgets.QSpinBox(parent=self.d_acquire_box)
        ...
        self.d_display_mode_spectra = QtWidgets.QComboBox(parent=self.d_acquire_box)
        ...
        self.label_41 = QtWidgets.QLabel(parent=self.d_acquire_box)
        self.label_41.setGeometry(QtCore.QRect(90, 130, 111, 21))
        self.label_41.setObjectName("label_41")
        self.d_use_ir_gain = QtWidgets.QCheckBox(parent=self.d_acquire_box)
        self.d_use_ir_gain.setGeometry(QtCore.QRect(260, 30, 71, 17))
        self.d_use_ir_gain.setObjectName("d_use_ir_gain")
        self.d_dcshotfactor_sb = QtWidgets.QSpinBox(parent=self.d_acquire_box)
        ...
        self.label_22 = QtWidgets.QLabel(parent=self.d_acquire_box)
        self.label_22.setGeometry(QtCore.QRect(220, 60, 111, 21))
        self.label_22.setObjectName("label_22")
        self.d_launch_box = QtWidgets.QGroupBox(parent=self.diagnostics_tab)
        self.d_launch_box.setGeometry(QtCore.QRect(10, 730, 341, 71))
        self.d_launch_box.setObjectName("d_launch_box")
        self.d_run_btn = QtWidgets.QPushButton(parent=self.d_launch_box)
        ...
        self.d_stop_btn = QtWidgets.QPushButton(parent=self.d_launch_box)
        ...
        self.label_51 = QtWidgets.QLabel(parent=self.d_other_box)
        self.label_51.setGeometry(QtCore.QRect(230, 60, 101, 21))
        self.label_51.setObjectName("label_51")
        self.d_threshold_value = QtWidgets.QSpinBox(parent=self.d_other_box)
        ...
        self.label_52 = QtWidgets.QLabel(parent=self.d_other_box)
        self.label_52.setGeometry(QtCore.QRect(230, 80, 101, 21))
        self.label_52.setObjectName("label_52")
        self.d_use_reference = QtWidgets.QCheckBox(parent=self.d_other_box)
        self.d_use_reference.setGeometry(QtCore.QRect(10, 50, 151, 17))
        self.d_use_reference.setObjectName("d_use_reference")
        self.d_set_linear_corr_btn = QtWidgets.QPushButton(parent=self.d_other_box)
        ...
        self.d_use_avg_off_shots = QtWidgets.QCheckBox(parent=self.d_other_box)
        self.d_use_avg_off_shots.setGeometry(QtCore.QRect(10, 70, 151, 17))
        self.d_use_avg_off_shots.setObjectName("d_use_avg_off_shots")
        self.d_max_dtt = QtWidgets.QDoubleSpinBox(parent=self.d_other_box)
        ...
        self.label_33 = QtWidgets.QLabel(parent=self.d_cutoff_box)
        self.label_33.setGeometry(QtCore.QRect(90, 50, 61, 21))
        self.label_33.setObjectName("label_33")
        self.label_34 = QtWidgets.QLabel(parent=self.d_cutoff_box)
        self.label_34.setGeometry(QtCore.QRect(90, 70, 61, 21))
        self.label_34.setObjectName("label_34")
        self.d_cutoff_pixel_high = QtWidgets.QSpinBox(parent=self.d_cutoff_box)
        ...
        self.d_cutoff_pixel_low = QtWidgets.QSpinBox(parent=self.d_cutoff_box)
        ...
        self.d_times_box = QtWidgets.QGroupBox(parent=self.diagnostics_tab)
        self.d_times_box.setGeometry(QtCore.QRect(10, 630, 341, 91))
        self.d_times_box.setObjectName("d_times_box")
        self.d_time = QtWidgets.QDoubleSpinBox(parent=self.d_times_box)
...
"background-color: rgb(255, 255, 255);")
        ...
        self.log = QtWidgets.QPlainTextEdit(parent=self.log_tab)
        ...
        self.statusBar = QtWidgets.QStatusBar(parent=pyTAgui)
    ...
    def retranslateUi(self, pyTAgui):
        ...
        self.label_5.setText(_translate("pyTAgui", "Delay Time Zero"))
        ...
        self.label_35.setText(_translate("pyTAgui", "Delay Time Zero"))
